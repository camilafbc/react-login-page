...
- **Recuperação de Senha**: A opção "Esqueceu sua senha?" na página de login leva a uma rota onde os usuários podem inserir o e-mail cadastrado para receber um link de recuperação de senha.
